        ...
        <div class="card-body">
            <form action="<?php echo site_url('jadwal/update') ?>" method="post">
                <div class="form-group row">
                    <input type="hidden" name="id_ka" id="id_ka" value=" <?= $jadwal['id_ka']; ?>">
                    <label for="nama" class="col-sm-2 label">Nama Kereta</label>
                    <div class="col-sm-4">
                        <input type="text" name="nama_ka" class="form-control" value="<?= $jadwal['nama_ka']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="date" name="tgl_berangkat" class="form-control" value="<?= $jadwal['tgl_berangkat']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nama" class="col-sm-2 label"> Tanggal Tiba</label>
                    <div class="col-sm-4">
                        <input type="date" name="tgl_sampai" class="form-control" value="<?= $jadwal['tgl_sampai']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nama" class="col-sm-2 label"> Jam Berangkat</label>
                    <div class="col-sm-4">
                        <input type="text" name="jam_berangkat" class="form-control" value="<?= $jadwal['jam_berangkat']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nama" class="col-sm-2 label"> Jam Tiba</label>
                    <div class="col-sm-4">
                        <input type="text" name="jam_tiba" class="form-control" value="<?= $jadwal['jam_tiba']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="harga" class="form-control" value="<?= $jadwal['harga']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nama" class="col-sm-2 label"> Stok</label>
                    <div class="col-sm-4">
                        <input type="text" name="stok" class="form-control" value="<?= $jadwal['stok']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-4">
